...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----|
            _______, _______, KC_LALT,MO(L_LOW), KC_SPC,        KC_ESC,MO(L_RAI),_______, _______,TG(L_GAM)
        //|--------+--------+--------+--------+--------|     |--------+--------+--------+--------+--------|
  ), [L_LOW] = LAYOUT(
  //|-----------------------------------------------------------------------------------------------------------|
          _______, _______, _______, _______, _______, _______,
  ...
  //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----|
            KC_LOCK, _______, _______, _______, KC_RSFT,       KC_LCTL, _______, _______, TG(L_NUM), TG(L_SPC)
        //|--------+--------+--------+--------+--------|     |--------+--------+--------+--------+--------|
  ), [L_NAV] = LAYOUT(
  //|-----------------------------------------------------------------------------------------------------------|
          _______, _______, _______, _______, _______, _______,
  ...
  //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----|
            _______, _______, _______, _______, _______,       _______, _______, _______, _______, KORLN
        //|--------+--------+--------+--------+--------|     |--------+--------+--------+--------+--------|
  ), [L_NUM] = LAYOUT(
  //|-----------------------------------------------------------------------------------------------------------|
  ...
  //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----|
            _______, _______, _______, _______, _______,       _______, _______, _______, _______,TG(L_NUM) 
        //|--------+--------+--------+--------+--------|     |--------+--------+--------+--------+--------|
  )
