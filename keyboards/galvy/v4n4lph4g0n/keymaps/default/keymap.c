...
void oled_render_layer_state(void) {
    ...
    switch (layer_state) {
        ...
        case (int)pow(2,L_SPC):
            oled_write_ln_P(PSTR("-Spe-"), false);
            break;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----|
  KC_TRNS,MO(L_NAV),KC_LGUI, LT(L_LOW,KC_TAB),  KC_LSFT,        KC_SPC,MO(L_RAI),LT(L_SPC,KC_RALT),MO(L_NAV),KC_TRNS
        //|--------+--------+--------+--------+--------|     |--------+--------+--------+--------+--------|
  ), [L_GAM] = LAYOUT(
  //|-----------------------------------------------------------------------------------------------------------|
  ...
  //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----|
            _______, _______, KC_LALT, MO(L_LOW), KC_SPC,       _______,MO(L_RAI),_______,TG(L_GAM), _______
        //|--------+--------+--------+--------+--------|     |--------+--------+--------+--------+--------|
  ), [L_LOW] = LAYOUT(
  //|-----------------------------------------------------------------------------------------------------------|
  ...
  //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----|
            KC_LOCK, _______, _______, _______, KC_RSFT,       KC_LCTL, TG(L_NUM),_______,TG(L_SPC),_______
        //|--------+--------+--------+--------+--------|     |--------+--------+--------+--------+--------|
  ), [L_NAV] = LAYOUT(
  //|-----------------------------------------------------------------------------------------------------------|
          _______, _______, _______, _______, _______, _______,
  ...
  //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----|
            _______, _______, _______, _______, _______,       _______, _______,   KORLN, _______, _______
        //|--------+--------+--------+--------+--------|     |--------+--------+--------+--------+--------|
  ), [L_NUM] = LAYOUT(
  //|-----------------------------------------------------------------------------------------------------------|
  ...
  //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----|
            _______, _______, _______, _______, _______,       _______, _______, _______,TG(L_NUM),_______
        //|--------+--------+--------+--------+--------|     |--------+--------+--------+--------+--------|
  )
